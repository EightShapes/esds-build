...
//Build everything
gulp.task('build:all', gulp.series('tokens:build:all', 'copy:all', gulp.parallel('scripts:build:all', 'styles:build:all', 'icons:build:all', gulp.series('markup:concatenate:macros:all', 'markup:build:all'))));
