...
// Watch everything
gulp.task('watch:all', gulp.parallel('watch:tokens:all', 'watch:styles:all', 'watch:markup:all', 'watch:serve:all'));

//Build everything
gulp.task('build:all', gulp.series('tokens:build:all', gulp.parallel('styles:build:all', gulp.series('markup:concatenate-macros:all', 'markup:build:all'))));
